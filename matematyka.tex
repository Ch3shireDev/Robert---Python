...
%\begin{proof}
%Największy wspólny dzielnik $x$ dwóch liczb pozwala na rozłożenie dwóch liczb na czynniki:
%
%$$a = x\cdot p_1,$$
%$$b = x\cdot p_2.$$
%
%Niech $y$ oznacza  najmniejszą wspólną wielokrotność. Wtedy według założeń zadania:
%
%$$a\cdot b = x\cdot y$$
%$$x\cdot p_1\cdot x\cdot p_2 = x \cdot y$$
%$$ x\cdot p_1\cdot p_2 = y$$
%
%Faktycznie, $y$ jest wielokrotnością zarówno $a$ jak i $b$. Nie wiemy jednak, czy nie istniałaby inna kombinacja
%
%\end{proof}
