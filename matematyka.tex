...
%
%\begin{itemize}
%\item Cecha BBB: bok-bok-bok. W trójkątach przystających długości trzech boków jednego trójkąta są odpowiednio równe długościom trzech boków drugiego trójkąta.
%\begin{figure}[h]
%\centering
%\includegraphics[width=0.5\linewidth]{cecha-bbb.png}
%\end{figure}
%\item Cecha BKB: bok-kąt-bok. Jeśli miary dwóch boków i kąta między nimi w jednym trójkącie są równe odpowiednio miarom dwóch boków i kąta między nimi w drugim trójkącie, to trójkąty są przystające.
%\begin{figure}[h]
%\centering
%\includegraphics[width=0.5\linewidth]{cecha-bkb.png}
%\end{figure}
%
%\item Cecha KBK: kąt-bok-kąt. Jeżeli dwa kąty i bok między nimi w jednym trójkącie mają miary równe dwóm kątom i bokowi między nimi w drugim trójkącie, to trójkąty są przystające.
%\begin{figure}[h]
%\centering
...
%\item Kąt BFE jest równy kątowi FCD
%\item Kąt ADE jest równy kątowi DCF
...
\newcommand\cke[1]{
\begin{figure}[h]
\includepdf[pages=#1, offset=0 0, scale=0.7]{./egzaminy/cke8.pdf}
\end{figure}
\newpage
}
...
\begin{figure}
\centering
\includegraphics[width=0.7\linewidth]{./egzaminy/zad#1.png}
\end{figure}
